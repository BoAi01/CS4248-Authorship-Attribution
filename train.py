...
def run_iterations(source):
    ...
    for limit in list_senders:
        ...
        train_ensemble(nlp_train, nlp_test,
                    ...
                    # 'ckpt/bert-base-cased/110_100auth_256tokens_hid512_epoch8_lr1e-05_bs32_drop0.4_acc0.87584.pt', #bert base case
                    # 'ckpt/deberta-base/25_100auth_256tokens_hid512_epoch6_lr1e-05_bs8_drop0.35_acc0.88989.pt', # deberta
                    # 'ckpt/roberta-base/24_100auth_256tokens_hid512_epoch6_lr1e-05_bs8_drop0.35_acc0.88257.pt',           # roberta
                    # 'ckpt/gpt2/26_100auth_256tokens_hid512_epoch6_lr0.0001_bs8_drop0.35_acc0.82923.pt',                               # gpt2
                    # 'ckpt/xlnet-base-cased/140_100auth_256tokens_hid512_epoch10_lr2e-05_bs32_drop0.35_acc0.87619.pt', # xlnet
                    'ckpt/bert-base-cased/110_50auth_256tokens_hid512_epoch8_lr1e-05_bs32_drop0.4_acc0.92154.pt', #bert base case
                    'ckpt/deberta-base/25_50auth_256tokens_hid512_epoch6_lr1e-05_bs8_drop0.35_acc0.92911.pt', # deberta
                    'ckpt/roberta-base/24_50auth_256tokens_hid512_epoch6_lr1e-05_bs8_drop0.35_acc0.92788.pt',           # roberta
                    'ckpt/gpt2/26_50auth_256tokens_hid512_epoch6_lr0.0001_bs8_drop0.35_acc0.88308.pt',                               # gpt2
                    'ckpt/xlnet-base-cased/140_50auth_256tokens_hid512_epoch10_lr2e-05_bs32_drop0.35_acc0.92210.pt', # xlnet
                    ...
                    num_epochs=300, base_bs=32, base_lr=1e-5, mlp_size=256, dropout=0.4, num_authors=50, # tune - parameters for ensemble final layer LR
